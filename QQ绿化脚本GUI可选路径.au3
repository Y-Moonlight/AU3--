...
#Region ### START Koda GUI section ### Form=D:\Users\Desktop\QQ\软件通用安装界面.kxf
DirCreate("C:\Windows\Temp\QQinstalltemp")
FileInstall("D:\Users\Desktop\QQ\ico.ico","C:\Windows\Temp\QQinstalltemp\")


$Form1 = GUICreate("腾讯QQ封装专用直装绿化版快速安装程序", 561, 368, -1, -1,$WS_CAPTION)
...
$Input1 = GUICtrlCreateInput("C:\Program Files (x86)", 19, 288, 457, 27,$ES_READONLY)
...
GUICtrlSetFont(-1, 10, 800, 0, "微软雅黑")
GUICtrlSetColor(-1, 0x000000)
$Icon1 = GUICtrlCreateIcon("C:\Windows\Temp\QQinstalltemp\ico.ico", -1, 24, 19, 48, 48)
GUISetState(@SW_SHOW)
...
While 1
	...
	Switch $nMsg
		Case $GUI_EVENT_CLOSE
			Exit
		Case $Button3
			DirRemove("C:\Windows\Temp\QQinstalltemp",1)
			Exit
		Case $Button1
			$sPath=FileSelectFolder("请选择安装路径","C:\Program Files (x86)")
			Sleep(500)
		...
		Case $Button2
			...
			Sleep(500)
			GUISetState(@SW_HIDE)
			FileInstall("D:\Users\Desktop\QQ\RunWait.exe","C:\Windows\Temp\QQinstalltemp\")
			Sleep(500)
			Run("C:\Windows\Temp\QQinstalltemp\RunWait.exe")
			Sleep(500)
			$PID=WinGetProcess ("执行进度")
			Sleep(500)
			FileInstall("D:\Users\Desktop\QQ\QQ9.6.6.28796.exe","C:\Windows\Temp\QQinstalltemp\")
			Sleep(500)
			RunWait('C:\Windows\Temp\QQinstalltemp\QQ9.6.6.28796.exe /ai /gm2 /InstallPath="' & $txt & '"')
			Sleep("500")
			ProcessClose ($PID)
			Sleep(500)
			MsgBox(0+64+65536,"提示","腾讯QQ安装完毕，敬请使用吧！")
			DirRemove("C:\Windows\Temp\QQinstalltemp",1)
			Exit
